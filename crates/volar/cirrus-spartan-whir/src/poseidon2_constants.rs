//! Poseidon2 round constants for the upstream-compatible KoalaBear profile.

use crate::KoalaBear;

pub(crate) const KOALABEAR_POSEIDON2_RC_16_EXTERNAL_INITIAL: [[KoalaBear; 16]; 4] =
...
pub(crate) const KOALABEAR_POSEIDON2_RC_16_EXTERNAL_FINAL: [[KoalaBear; 16]; 4] =
    KoalaBear::new_2d_array([
        [
...
pub(crate) const KOALABEAR_POSEIDON2_RC_16_INTERNAL: [KoalaBear; 20] = KoalaBear::new_array([
...
pub(crate) const KOALABEAR_POSEIDON2_RC_24_EXTERNAL_INITIAL: [[KoalaBear; 24]; 4] =
    KoalaBear::new_2d_array([
        [
...
pub(crate) const KOALABEAR_POSEIDON2_RC_24_EXTERNAL_FINAL: [[KoalaBear; 24]; 4] =
    KoalaBear::new_2d_array([
        [
...
pub(crate) const KOALABEAR_POSEIDON2_RC_24_INTERNAL: [KoalaBear; 23] = KoalaBear::new_array([
